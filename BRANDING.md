...
- Codex maintenance shell override: FIREBREAK_AGENT_MODE=shell nix run .#firebreak-codex
- Codex smoke test entry: firebreak-test-smoke-codex
- Claude Code VM entry: firebreak-claude-code
- Claude Code maintenance shell override: FIREBREAK_AGENT_MODE=shell nix run .#firebreak-claude-code
