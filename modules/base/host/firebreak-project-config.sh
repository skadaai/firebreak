...
firebreak_project_config_key_allowed() {
  case "$1" in
    AGENT_CONFIG|AGENT_CONFIG_HOST_PATH|FIREBREAK_VM_MODE|FIREBREAK_WORKER_PROXY_MODE|CODEX_CONFIG|CODEX_CONFIG_HOST_PATH|CLAUDE_CONFIG|CLAUDE_CONFIG_HOST_PATH)
      return 0
      ;;
    *)
      return 1
