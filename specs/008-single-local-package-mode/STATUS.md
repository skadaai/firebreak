...
- the local wrapper defaults to `run` mode semantics and now documents `FIREBREAK_LAUNCH_MODE=shell` as the public shell override
...
- 2026-03-23: Reopened the changeset so the public contract converges on `FIREBREAK_LAUNCH_MODE` without legacy mode aliases.
